#pagina com dados bruto e com filtro
...
#base de dados que serão mostrada na página------------------------
...
#filtro que será mostrado na página central--------------------------------
...
#campos com filtro para ser selecionados---------------------------------------
...
#query-----------------------------------------------------------------------
#Produto, Preço, `Data de compra`,...  ->coluna da base
#@produtos, @preço, @data_compra,... ->campos selecionados  ...[0],...[1]  ->incio,fim
...
#mostra dados brutos filtrado no browser
